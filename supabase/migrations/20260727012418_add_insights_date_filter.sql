...
DROP FUNCTION public.get_award_insights();
CREATE FUNCTION public.get_award_insights(start_date date DEFAULT NULL::date, end_date date DEFAULT NULL::date)
 RETURNS json
 LANGUAGE sql
...
$function$;
GRANT ALL ON FUNCTION public.get_award_insights(date, date) TO anon;
GRANT ALL ON FUNCTION public.get_award_insights(date, date) TO authenticated;
